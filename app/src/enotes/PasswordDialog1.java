 ...
 * @author ivoras
 */
public class PasswordDialog1 extends javax.swing.JDialog {

    private String pwd = null;

    /** Creates new form PasswordDialog */
    public PasswordDialog1() {
        initComponents();
    }
    ...
    private void pwf1KeyReleased(KeyEvent evt) {//GEN-FIRST:event_pwf1KeyReleased
        if (evt.getKeyCode() == KeyEvent.VK_ENTER)
            clickOk();
    }//GEN-LAST:event_pwf1KeyReleased
    ...
    public static String getPassword() {
        PasswordDialog1 pd = new PasswordDialog1();
